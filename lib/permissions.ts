...
export const PERMISSION_CATALOG: ReadonlyArray<{
  ...
  { key: PERMISSIONS.KITCHEN_VIEW, group: "Cocina", label: "Ver comandas", description: "Consultar las comandas enviadas a cocina." },
  { key: PERMISSIONS.KITCHEN_WRITE, group: "Cocina", label: "Actualizar comandas", description: "Cambiar el estado de preparación de las comandas." },
